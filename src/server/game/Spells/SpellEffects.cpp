...
void Spell::EffectDispel(SpellEffIndex effIndex)
{
    ...
    unitTarget->GetDispellableAuraList(m_caster, dispelMask, dispel_list, m_spellInfo, checkPositiveAuraWhenFriendly);
...
void Spell::EffectDistract(SpellEffIndex /*effIndex*/)
{
    ...
    if (unitTarget->HasUnitState(UNIT_STATE_CONFUSED | UNIT_STATE_STUNNED | UNIT_STATE_FLEEING | UNIT_STATE_CASTING))
        return;
